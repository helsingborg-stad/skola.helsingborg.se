...
namespace MunicipioHighSchool\PostTypes;
...
class ForParents
{
    ...
    {
        $nameSingular = __('Page for parents', 'municipio-school');
        $namePlural = __('Pages for parents', 'municipio-school');
        ...
        $labels = array(
            ...
            'add_new'            => _x('Add New', 'add new button', 'municipio-school'),
            'add_new_item'       => sprintf(__('Add new %s', 'municipio-school'), $nameSingular),
            'new_item'           => sprintf(__('New %s', 'municipio-school'), $nameSingular),
            'edit_item'          => sprintf(__('Edit %s', 'municipio-school'), $nameSingular),
            'view_item'          => sprintf(__('View %s', 'municipio-school'), $nameSingular),
            'all_items'          => sprintf(__('All %s', 'municipio-school'), $namePlural),
            'search_items'       => sprintf(__('Search %s', 'municipio-school'), $namePlural),
            'parent_item_colon'  => sprintf(__('Parent %s', 'municipio-school'), $namePlural),
            'not_found'          => sprintf(__('No %s', 'municipio-school'), $namePlural),
            'not_found_in_trash' => sprintf(__('No %s in trash', 'municipio-school'), $namePlural)
        );

        $args = array(
            'labels'               => $labels,
            'description'          => __('Pages designated for parents with children in this school', 'municipio-school'),
            'menu_icon'            => $icon,
            'public'               => true,
            ...
            'has_archive'          => true,
            'rewrite'              => array(
                'slug'       => __('for-parents', 'municipio-school'),
                'with_front' => false
            ),
            'capabilities' => array(
