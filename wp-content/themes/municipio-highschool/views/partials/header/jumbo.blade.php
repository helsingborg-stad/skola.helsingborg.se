...
<nav class="navbar navbar-mainmenu hidden-print {{ is_front_page() && get_field('header_transparent', 'option') ? 'navbar-transparent' : '' }} {{ get_field('header_sticky', 'option') ? 'navbar-sticky' : '' }}"> <!-- Changed from sticky-scroll to navbar-sticky -->
    <div class="container">
        <div class="grid">
